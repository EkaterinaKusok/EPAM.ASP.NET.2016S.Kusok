...
{
    [Subject("Routing")]
    public class When_Route_is_Home_Index_AlphaId
    {
        ...
        Establish that = () =>
        {
            ...
            httpContextMock.Setup(c => c.Request.AppRelativeCurrentExecutionFilePath).Returns("~/Home/Index/abc");
        };
        ...
        It should_have_id_with_value_abc = () =>
        {
            routeData.Values["Id"].ShouldEqual("abc");
        };

        It should_have_route_with_value_NamespacePriority1 = () =>
        {
            routeData.Route.ShouldEqual(routes["NamespacePriority1"]);
        };
    }
}
